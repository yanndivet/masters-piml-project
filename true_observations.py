...
def generate_true_observations(number_systems=cs.N_SYSTEMS, experiment_number=1):
...
def save_true_observations(number_systems=cs.N_SYSTEMS, experiment_number=1):
    ...
    df_true_observations.write_parquet(f"true_observations/experiment_{experiment_number}/N={number_systems}.parquet")
    return df_true_observations

def read_true_observations(number_systems=cs.N_SYSTEMS, experiment=1, make_new_observations=False):
